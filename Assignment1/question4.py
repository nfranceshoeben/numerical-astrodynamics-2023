...
ganymede_position_elements_1 = kepler_elements_1[:,-6:-3]
ganymede_position_elements_2 = kepler_elements_2[:,-6:-3]
...
diff1 =  r_G_sc_1 - position_elements_q1
diff2 =  r_G_sc_2 - position_elements_q2
...
r_J_sc_1 = np.genfromtxt('JUICEPropagationHistory_Q4_1.dat')
r_J_sc_2 = np.genfromtxt('JUICEPropagationHistory_Q4_2.dat')

ganymede_elements_1 = kepler_elements_1[:,-6:]
ganymede_elements_2 = kepler_elements_2[:,-6:]

final_1 = r_J_sc_1[:,1:] - ganymede_elements_1
final_2 = r_J_sc_2[:,1:] - ganymede_elements_2
